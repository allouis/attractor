...
| [visit-dirs.md](./visit-dirs.md) *(superseded)* | §5.6 (run directory structure) | Per-visit stage dirs `{node_id}/v{N}/` with node-root mirrors. Superseded by span-dirs.md. |

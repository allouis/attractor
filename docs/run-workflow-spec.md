...
| R4 | Run modal: workflow dropdown → dynamic prefilled var fields + repo dropdown; item-row and Workflows-view entry points; migrate off `/items/run` and remove it | R1, R2, R3 | done |
| R5 | Polish: required-var validation, error surfaces, the router-needs-an-item note, empty/loading states | R4 | done |
